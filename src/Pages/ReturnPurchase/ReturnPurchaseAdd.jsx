    ...
    return (
        <div className="p-6 bg-white min-h-screen">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <Button type="submit" className="bg-gray-700 hover:bg-gray-800 text-white px-12" disabled={postLoading}>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-0 border rounded-lg bg-slate-50 mt-10 text-center">
                    ...
                    <div className="p-4 bg-white">
                        <p className="text-[10px] text-gray-600 uppercase font-black">{t("Grand Total")}</p>
                        <p className="font-black text-xl text-gray-700">{calculateGrandTotal().toFixed(2)}</p>
                    </div>
                </div>
            </form>
        </div>
